...
SAS_config_names=['iomALZBBVA', 'iomALZBrasil', 'iomALZColombia', 'iomALZPortugal', 'iomALZSeguros', 'iomFenix', 'iomSASApp']
...
iomALZBBVA = {'java'  : '/opt/anaconda3/envs/bi_development/bin/java',
            'iomhost'   : 'lnxsasdtcn',
            'iomport'   : 8596,
            }
iomALZBrasil = {'java'  : '/opt/anaconda3/envs/bi_development/bin/java',
            'iomhost'   : 'lnxsasdtcn',
            'iomport'   : 8598,
            }
iomALZColombia = {'java'  : '/opt/anaconda3/envs/bi_development/bin/java',
            'iomhost'   : 'lnxsasdtcn',
            'iomport'   : 8597,
            }
iomALZPortugal = {'java'  : '/opt/anaconda3/envs/bi_development/bin/java',
            'iomhost'   : 'lnxsasdtcn',
            'iomport'   : 8594,
            }
iomALZSeguros = {'java'  : '/opt/anaconda3/envs/bi_development/bin/java',
            'iomhost'   : 'lnxsasdtcn',
            'iomport'   : 8593,
            }
iomFenix = {'java'  : '/opt/anaconda3/envs/bi_development/bin/java',
            'iomhost'   : 'lnxsasdtcn',
            'iomport'   : 8595,
            }
iomSASApp = {'java'  : '/opt/anaconda3/envs/bi_development/bin/java',
            'iomhost'   : 'lnxsasdtcn',
            'iomport'   : 8591,
            }
